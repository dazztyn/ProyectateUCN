...
export class CrearEstructuraNAN1765998233796 implements MigrationInterface {
    name = 'CrearEstructuraNAN1765998233796'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "instancias_asignaturas" ADD CONSTRAINT "FK_b8a9bf27fcec5d639da47177831" FOREIGN KEY ("semestreIdSemestre") REFERENCES "semestres"("idSemestre") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "semestres" ADD CONSTRAINT "FK_baf60d69cbf216750ac965220bb" FOREIGN KEY ("proyeccionIdProyeccion") REFERENCES "proyecciones"("idProyeccion") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
