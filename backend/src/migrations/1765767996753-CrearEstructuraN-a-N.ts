...
export class CrearEstructuraNAN1765767996753 implements MigrationInterface {
    name = 'CrearEstructuraNAN1765767996753'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "instancias_asignaturas" ("id" SERIAL NOT NULL, "estado" character varying NOT NULL DEFAULT 'PENDIENTE', "semestreIdSemestre" integer, "asignaturaCodigoAsignatura" text, CONSTRAINT "PK_b74ac23173871bf3295fc736161" PRIMARY KEY ("id"))`);
